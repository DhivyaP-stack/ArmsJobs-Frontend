...
import { Candidatestatus } from '../../Commonapicall/Candidateapicall/Candidateapis';
import { toast } from 'react-toastify';

interface StatusCandidatePopupProps {
    closePopup: () => void;
    CandidateStatus: {
        id: number;
        name: string;
...
export const StatusCandidatePopup: React.FC<StatusCandidatePopupProps> = ({
    ...
    const handleConfirm = async () => {
        setError(null);
        try {
            const newStatus = !CandidateStatus.currentStatus;
            const response = await Candidatestatus(
            ...
            <div className="container mx-auto">
                <div className="relative bg-white rounded-[5px] w-4/12 mx-auto px-5 py-5">
                    <div className="relative mb-10">
                        <h2 className="text-2xl text-armsBlack font-semibold pb-3 border-b-2 border-armsgrey ">Candidate Status</h2>
