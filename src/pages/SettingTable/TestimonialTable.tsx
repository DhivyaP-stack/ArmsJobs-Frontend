...
export const TestimonialTable: React.FC = () => {
            ...
            <table className="w-full table-auto text-sm ">
                ...
                <tbody className="text-black">
                    <tr className="border-b ">
                        <td className="px-2 py-5 font-medium content-start">Tes050525</td>
                        <td className="px-2 py-5 font-medium content-start">Mohamed Illyas</td>
                        <td className="px-2 py-5 font-medium content-start">www.highscope.ae</td>
